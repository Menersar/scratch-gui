...
import DocumentationLink from '../sidekick-documentation-link/documentation-link.jsx';
    ...
    <BooleanSetting
        ...
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.highQualityPenHelp"
            />
        }
                    ...
                    customFramerate: (
                        ...
                        >
                            <FormattedMessage
                                ...
                                id="gui.settingsModal.fpsHelp.customFramerate"
                            />
                        </a>
                    )
                }}
    ...
    <BooleanSetting
        ...
        label={
            <FormattedMessage
                ...
                id="gui.settingsModal.interpolation"
            />
        }
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.interpolationHelp"
            />
        }
        slug="interpolation"
    />
    ...
    <BooleanSetting
        ...
        label={
            <FormattedMessage
                ...
                id="gui.settingsModal.infiniteClones"
            />
        }
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.infiniteClonesHelp"
            />
        }
    ...
    <BooleanSetting
        ...
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.removeFencingHelp"
            />
        }
        slug="remove-fencing"
    />
    ...
    <BooleanSetting
        ...
        label={
            <FormattedMessage
                ...
                id="gui.settingsModal.removeMiscLimits"
            />
        }
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.removeMiscLimitsHelp"
            />
        }
    ...
    <BooleanSetting
        ...
        label={
            <FormattedMessage
                ...
                id="gui.settingsModal.warpTimer"
            />
        }
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.warpTimerHelp"
            />
        }
        slug="warp-timer"
    />
    ...
    <BooleanSetting
        ...
        label={
            <FormattedMessage
                ...
                id="gui.settingsModal.disableCompiler"
            />
        }
        help={
            <FormattedMessage
                ...
                id="gui.settingsModal.disableCompilerHelp"
            />
        }
    ...
    <Setting
        ...
        primary={(
            <div className={classNames(styles.label, styles.customStageSize)}>
                <FormattedMessage
                    ...
                    id="gui.settingsModal.customStageSize"
                />
                <BufferedInput
                    value={stageWidth}
            ...
            (stageWidth >= 1000 || stageHeight >= 1000) && (
                <div className={styles.warning}>
                    <FormattedMessage
                        ...
                        id="gui.settingsModal.largeStageWarning"
                    />
        ...
        help={(
            <FormattedMessage
                ...
                description="Custom Stage Size option"
                id="gui.settingsModal.customStageSizeHelp"
            />
        )}
        ...
        <div>
            ...
            >
                <FormattedMessage
                    ...
                    id="gui.settingsModal.storeProjectOptions"
                />
            </button>
            <p>
                <FormattedMessage
                    // eslint-disable-next-line max-len
                    defaultMessage="Stores the selected settings in the project so they will be automatically applied when Sidekick loads this project. Warp timer and disable compiler will not be saved."
                    description="Help text for the store settings in project button"
                    id="gui.settingsModal.storeProjectOptionsHelp"
                />
            </p>
        </div>
    </div>
        ...
        <Box className={styles.body}>
            ...
            <Header>
                <FormattedMessage
                    ...
                    description="Settings modal section"
                    id="gui.settingsModal.removeLimits"
                />
            </Header>
            <InfiniteClones
            ...
            <Header>
                <FormattedMessage
                    ...
                    description="Settings modal section"
                    id="gui.settingsModal.dangerZone"
                />
            </Header>
            {!props.isEmbedded && (
                <CustomStageSize
