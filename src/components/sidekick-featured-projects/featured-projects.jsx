...
import StudioView from '../sidekick-studioview/studioview.jsx';
import styles from './featured-projects.css';
import {setProjectId} from '../../lib/sidekick-navigation-utils.js';
                ...
                <div className={styles.footer}>
                    ...
                    >
                        <FormattedMessage
                            ...
                            // !!! ???
                            description="Link to sidekick featured projects studio"
                            id="gui.featuredProjectsStudio"
                        />
                    </a>
                </div>
            </div>
