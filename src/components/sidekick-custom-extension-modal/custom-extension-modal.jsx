...
const messages = defineMessages({
    title: {
        ...
        id: 'gui.customExtensionModal.title'
    }
});
            ...
            <div className={styles.typeSelectorContainer}>
                ...
                >
                    <FormattedMessage
                        ...
                        id="gui.customExtensionModal.url"
                    />
                </div>
                <div
                    className={styles.typeSelectorButton}
                ...
                >
                    <FormattedMessage
                        ...
                        id="gui.customExtensionModal.file"
                    />
                </div>
                <div
                    className={styles.typeSelectorButton}
                ...
                >
                    <FormattedMessage
                        ...
                        id="gui.customExtensionModal.text"
                    />
                </div>
            </div>
                ...
                <React.Fragment key={props.type}>
                    <p>
                        <FormattedMessage
                            ...
                            id="gui.customExtensionModal.promptURL"
                        />
                    </p>
                    <input
                        type="text"
                ...
                <React.Fragment key={props.type}>
                    <p>
                        <FormattedMessage
                            ...
                            id="gui.customExtensionModal.promptFile"
                        />
                    </p>
                    <FileInput
                        accept=".js"
                ...
                <React.Fragment key={props.type}>
                    <p>
                        <FormattedMessage
                            ...
                            id="gui.customExtensionModal.promptText"
                        />
                    </p>
                    <textarea
                ...
                <React.Fragment>
                    <label className={styles.unsandboxedContainer}>
                        ...
                        <FormattedMessage
                            ...
                            id="gui.customExtensionModal.unsandboxed"
                        />
                    </label>
                    {props.unsandboxed && (
                        <p className={styles.unsandboxedWarning}>
                            <FormattedMessage
                                ...
                                id="gui.customExtensionModal.unsandboxedWarning1"
                            />
                            <FormattedMessage
                                // eslint-disable-next-line max-len
                                ...
                                description="Warning that appears when disabling extension security sandbox"
                                id="gui.customExtensionModal.unsandboxedWarning2"
                                values={{
                                    APP_NAME
                                }}
                            />
                ...
                props.unsandboxed ? (
                    <p className={styles.trustedExtension}>
                        <FormattedMessage
                            ...
                            description="Message that appears in custom extension prompt"
                            id="gui.customExtensionModal.trusted"
                        />
                    </p>
                ) : (
                    <p>
                        <FormattedMessage
                            ...
                            description="Message that appears in custom extension prompt"
                            id="gui.customExtensionModal.untrusted"
                        />
                    </p>
                )
            )}
            ...
            <div className={styles.buttonRow}>
                ...
                >
                    <FormattedMessage
                        ...
                        id="gui.customExtensionModal.load"
                    />
                </button>
            </div>
        </Box>
