            ...
            {props.mustChangeUsername && <React.Fragment>
                <p className={classNames(styles.helpText, styles.mustChange)}>
                    <FormattedMessage
                        ...
                        id="gui.usernameModal.mustChange"
                        values={{
                            resetIt: (
                                <a
                                ...
                                >
                                    <FormattedMessage
                                        ...
                                        id="gui.usernameModal.mustChange.resetIt"
                                    />
                                </a>
                            )
                        }}
