...
import {getInitialDarkMode} from '../../lib/sidekick-theme-hoc.jsx';
...
document.title = `${settingsTranslations.title} - Sidekick`;
    ...
    handleChange (e) {
        ...
        this.setState({value: e.target.value}, () => {
            ...
            if (!this.state.focused) {
                // Utilize the number spinner of a browser to be able to fire it.
                this.handleFlush(e);
            }
        });
    }
...
class AddonSettingsComponent extends React.Component {
    ...
    handleSettingStoreChanged (e) {
        ...
        // Check if a a reload has to be performed.
        // 'changeChannel' is the name of the channel to connect to.
        // For asynchronous one-to-many communication with BroadcastChannel instances bound to the same channel name.
        // (For more information see source: https://nodejs.org/api/worker_threads.html#class-broadcastchannel-extends-eventtarget)
        // Thus, if channels are not accessible a reload per change is necessary.
    ...
    handleReloadNow () {
        // 'postMessage' sends the message to other BroadcastChannel objects set up for this channel.
        // Messages can be structured objects, e.g. nested objects and arrays.
        // For the purpose here however, the value of the message is not relevant.
    ...
    handleKeyDown (e) {
        ...
        // Call the 'preventDefault' function.
        // In case the search bar is focused:
        // Do not prevent a browser's 'ctrl + f' functionality (so that it remains accessible).
                    ...
                    {!this.state.loading && (
                        <div className={styles.section}>
                            ...
                            <footer className={styles.footer}>
                                ...
                                >
                                    {this.state.extended ?
                                        // TODO: Create and implement translations for the following statements.
                                        // (Low priority though,
                                        // since chances are that it will never be accessed during normal operation.
