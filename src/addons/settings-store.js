...
class SettingsStore extends EventTargetShim {
     ...
     * @returns {object} Addon Storage object.
     */
     ...
     * @private
     * @param {string} addonId The ID of the addon.
     * @returns {object} Addon Manifest object.
     */
     ...
     * @param {string} settingId The ID of the addon.
     * @returns {object} Addon Settings object.
     */
    ...
    evaluateCondition (addonId, condition) {
        ...
        if (condition.settings) {
            ...
            for (const [settingName, expectedValue] of Object.entries(
                ...
                if (
                    this.getAddonSetting(addonId, settingName) !== expectedValue
                ) {
                    return false;
                }
            }
