...
import SecurityManagerModal from '../components/sidekick-security-manager-modal/security-manager-modal.jsx';
import SecurityModals from '../lib/sidekick-security-manager-constants';
...
const isTrustedExtension = url => (
    ...
    // Always trust official extension repostiory.
    // !!! TEST BUG FIX
...
class SidekickSecurityManagerComponent extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handleAllowed',
...
SidekickSecurityManagerComponent.propTypes = {
    vm: PropTypes.shape({
...
const ConnectedSecurityManagerComponent = connect(
    mapStateToProps,
    mapDispatchToProps
)(SidekickSecurityManagerComponent);
