...
import SidekickRestorePointModal from '../components/sidekick-restore-point-modal/restore-point-modal.jsx';
import RestorePointAPI from '../lib/sidekick-restore-point-api';
...
const messages = defineMessages({
    confirmLoad: {
        ...
        id: 'gui.restorePoints.confirmLoad'
    },
    confirmDelete: {
        ...
        id: 'gui.restorePoints.confirmDelete'
    },
    confirmDeleteAll: {
        ...
        id: 'gui.restorePoints.confirmDeleteAll'
    },
    loadError: {
        defaultMessage: 'Error loading restore point: {error}',
        description: 'Error message when a restore point could not be loaded',
        id: 'gui.restorePoints.error'
    }
});

class SidekickRestorePointManager extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handleClickCreate',
...
SidekickRestorePointManager.propTypes = {
    intl: intlShape,
...
const mapDispatchToProps = dispatch => ({
    onStartCreatingRestorePoint: () => dispatch(showStandardAlert('sidekickCreatingRestorePoint')),
    onFinishCreatingRestorePoint: () => showAlertWithTimeout(dispatch, 'sidekickRestorePointSuccess'),
    onErrorCreatingRestorePoint: () => showAlertWithTimeout(dispatch, 'sidekickRestorePointError'),
