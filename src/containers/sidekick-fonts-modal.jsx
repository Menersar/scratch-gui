...
import FontsModalComponent from '../components/sidekick-fonts-modal/fonts-modal.jsx';

class SidekickFontsModal extends React.Component {
    constructor (props) {
        super(props);
        bindAll(this, [
            'handleClose',
