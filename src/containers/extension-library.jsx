...
const fetchLibrary = async () => {
    ...
    const res = await fetch('https://menersar.github.io/sidekick-extensions/generated-metadata/extensions-v0.json');
    if (!res.ok) {
    ...
    return data.extensions.map(extension => ({
        ...
        extensionURL: `https://menersar.github.io/sidekick-extensions/${extension.slug}.js`,
        // iconURL: `https://extensions.turbowarp.org/${extension.image || 'images/unknown.svg'}`,
        iconURL: `https://menersar.github.io/sidekick-extensions/${extension.image || 'images/unknown.svg'}`,
        // !!! KA !!!
        // !!! CHANGE !!!
        // tags: ['tw'],
        tags: ['sidekick'],
        ...
        docsURI: extension.docs ? `https://menersar.github.io/sidekick-extensions/${extension.slug}` : null,
        samples: extension.samples ? extension.samples.map(sample => ({
            // href: `${process.env.ROOT}editor?project_url=https://extensions.turbowarp.org/samples/${encodeURIComponent(sample)}.sb3`,
            href: `${process.env.ROOT}editor?project_url=https://menersar.github.io/sidekick-extensions/samples/${encodeURIComponent(sample)}.sb3`,
            text: sample
        })) : null,
