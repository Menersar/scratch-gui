// !!!
const SET_FRAMERATE = 'sidekick/SET_FRAMERATE';
const SET_INTERPOLATION = 'sidekick/SET_INTERPOLATION';
const SET_COMPILER_OPTIONS = 'sidekick/SET_COMPILER_OPTIONS';
const SET_RUNTIME_OPTIONS = 'sidekick/SET_RUNTIME_OPTIONS';
const SET_USERNAME = 'sidekick/SET_USERNAME';
const SET_CLOUD = 'sidekick/SET_CLOUD';
const SET_HIGH_QUALITY_PEN = 'sidekick/SET_HIGH_QUALITY_PEN';
const SET_WINDOW_FULLSCREEN = 'sidekick/SET_WINDOW_FULLSCREEN';
const SET_DIMENSIONS = 'sidekick/SET_DIMENSIONS';
const SET_AUTHOR = 'sidekick/SET_AUTHOR';
const SET_DESCRIPTION = 'sidekick/SET_DESCRIPTION';
const ADD_COMPILE_ERROR = 'sidekick/ADD_COMPILE_ERROR';
const CLEAR_COMPILE_ERRORS = 'sidekick/CLEAR_COMPILE_ERRORS';
