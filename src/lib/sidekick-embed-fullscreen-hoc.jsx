...
import {setIsWindowFullScreen} from '../reducers/sidekick';
import FullscreenAPI from './sidekick-fullscreen-api';

const SidekickFullScreenHOC = function (WrappedComponent) {
...
export {
    SidekickFullScreenHOC as default
};
