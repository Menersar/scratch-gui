...
import {setAuthor, setDescription} from '../reducers/sidekick';
...
const SidekickProjectMetaFetcherHOC = function (WrappedComponent) {
        ...
        componentDidUpdate () {
            ...
            fetchProjectMeta(projectId)
                .then(data => {
                    ...
                    // !!! CHANGE !!!
                    const authorThumbnail = `https://uploads.scratch.mit.edu/users/avatars/${data.author.id}`;
...
export {
    SidekickProjectMetaFetcherHOC as default
};
