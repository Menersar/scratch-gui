...
const _computeRMS = function (samples, start, end, scaling = 0.55) {
    ...
    // Note: Moved to https://github.com/Tonejs/Tone.js/blob/master/Tone/component/analysis/Meter.ts#L98 (as of 24.07.2023)
    let sum = 0;
...
const downsampleIfNeeded = (buffer, resampler) => {
    ...
    // If the sound got downsampled and still is too large the GUI refuses editing and emits a warning.
    return resampler({samples, sampleRate}, 22050);
};
