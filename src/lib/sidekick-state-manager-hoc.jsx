...
import {generateRandomUsername} from './sidekick-username';
import {setSearchParams} from './sidekick-navigation-utils';
...
const SidekickStateManager = function (WrappedComponent) {
...
export {
    SidekickStateManager as default
};
